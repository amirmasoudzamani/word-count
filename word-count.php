...
/*
    ...
    Description: A article word counter plugin
    Version: 1.0
    Author: Amirmasoud Zamani
    Author URI: https://codeexplore.ir
    Text Domain: wc-domain
...
class WordCountAndTimePlugin {
    ...
    <?php }
    function adminPage(){
        add_options_page('Word Count Settings', esc_html__('Word Count', 'wcpdomain'), 'manage_options', 'word-count-settings-page', array($this, 'settingsPageHTML'));
    }
